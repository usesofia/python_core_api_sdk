...
class TestMessageTokenEntityWorksapce(unittest.TestCase):
    """MessageTokenEntityWorksapce unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageTokenEntityWorksapce:
        """Test MessageTokenEntityWorksapce
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageTokenEntityWorksapce`
        """
        model = MessageTokenEntityWorksapce()
        if include_optional:
            return MessageTokenEntityWorksapce(
                id = '',
                pretty_id = 'p0',
                name = '0',
                type = 'PERSONAL',
    ...
    def testMessageTokenEntityWorksapce(self):
        """Test MessageTokenEntityWorksapce"""
