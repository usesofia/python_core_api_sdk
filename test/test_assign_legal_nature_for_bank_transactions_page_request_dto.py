...
class TestAssignLegalNatureForBankTransactionsPageRequestDto(unittest.TestCase):
    """AssignLegalNatureForBankTransactionsPageRequestDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignLegalNatureForBankTransactionsPageRequestDto:
        """Test AssignLegalNatureForBankTransactionsPageRequestDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignLegalNatureForBankTransactionsPageRequestDto`
        """
        model = AssignLegalNatureForBankTransactionsPageRequestDto()
        if include_optional:
            return AssignLegalNatureForBankTransactionsPageRequestDto(
                sync_item_id = '',
                page_number = 56,
    ...
    def testAssignLegalNatureForBankTransactionsPageRequestDto(self):
        """Test AssignLegalNatureForBankTransactionsPageRequestDto"""
