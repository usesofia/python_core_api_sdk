...
class TestBankTransactionsPageEntity(unittest.TestCase):
    """BankTransactionsPageEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankTransactionsPageEntity:
        """Test BankTransactionsPageEntity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankTransactionsPageEntity`
        """
        model = BankTransactionsPageEntity()
        if include_optional:
            return BankTransactionsPageEntity(
                page_index = 1.337,
                page_size = 1.337,
                total_items = 1.337,
                total_pages = 1.337,
                items = [
                    openapi_client.models.bank_transaction_entity.BankTransactionEntity(
                        id = '', 
                        account_id = '', 
    ...
    def testBankTransactionsPageEntity(self):
        """Test BankTransactionsPageEntity"""
