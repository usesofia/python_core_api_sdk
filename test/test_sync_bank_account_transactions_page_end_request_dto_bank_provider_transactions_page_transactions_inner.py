...
class TestSyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner(unittest.TestCase):
    """SyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner:
        """Test SyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner`
        """
        model = SyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner()
        if include_optional:
            return SyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner(
                id = '',
                description = '',
                posted_date = None,
                amount = 56,
    ...
    def testSyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner(self):
        """Test SyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner"""
