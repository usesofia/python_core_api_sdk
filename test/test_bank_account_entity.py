...
class TestBankAccountEntity(unittest.TestCase):
    """BankAccountEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BankAccountEntity:
        """Test BankAccountEntity
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BankAccountEntity`
        """
    ...
    def testBankAccountEntity(self):
        """Test BankAccountEntity"""
