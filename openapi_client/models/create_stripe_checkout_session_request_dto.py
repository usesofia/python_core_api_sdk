...
class CreateStripeCheckoutSessionRequestDto(BaseModel):
    """
    CreateStripeCheckoutSessionRequestDto
    """ # noqa: E501
    workspace_id: StrictStr = Field(alias="workspaceId")
    price_id: StrictStr = Field(alias="priceId")
    is_trial: StrictBool = Field(alias="isTrial")
    __properties: ClassVar[List[str]] = ["workspaceId", "priceId", "isTrial"]
