...
class BankTransactionTagsApi:
    ...
    async def bank_transaction_tags_controller_create(
        ...
        :param create_bank_transaction_tag_request_dto: (required)
        :type create_bank_transaction_tag_request_dto: CreateBankTransactionTagRequestDto
    ...
    def _bank_transaction_tags_controller_create_serialize(
        ...
        if create_bank_transaction_tag_request_dto is not None:
            _body_params = create_bank_transaction_tag_request_dto
