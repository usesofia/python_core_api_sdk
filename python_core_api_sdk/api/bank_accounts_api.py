...
class BankAccountsApi:
    ...
    @validate_call
    async def bank_accounts_controller_create_workspace_balance_report(
        self,
        ...
        _param = self._bank_accounts_controller_create_workspace_balance_report_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "BankAccountsBalanceReportEntity",
        }
        response_data = await self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    async def bank_accounts_controller_create_workspace_balance_report_with_http_info(
        self,
        workspace_id: StrictStr,
        enabled: Optional[StrictBool] = None,
        types: Optional[StrictStr] = None,
    ...
    @validate_call
    async def bank_accounts_controller_create_workspace_balance_report_without_preload_content(
        self,
        workspace_id: StrictStr,
        enabled: Optional[StrictBool] = None,
        types: Optional[StrictStr] = None,
    ...
    def _bank_accounts_controller_create_workspace_balance_report_serialize(
        self,
        workspace_id,
        enabled,
        types,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/bank/workspaces/{workspaceId}/accounts/balance-report',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
