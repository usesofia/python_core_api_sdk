...
class ProfilesApi:
    ...
    async def profiles_controller_create(
        ...
        :param create_profile_request_dto: (required)
        :type create_profile_request_dto: CreateProfileRequestDto
        ...
        _param = self._profiles_controller_create_serialize(
            create_profile_request_dto=create_profile_request_dto,
    ...
    def _profiles_controller_create_serialize(
        self,
        create_profile_request_dto,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_profile_request_dto is not None:
            _body_params = create_profile_request_dto
    ...
    async def profiles_controller_get_my(
        ...
        _param = self._profiles_controller_get_my_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _profiles_controller_get_my_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
