...
class StripeApi:
    ...
    async def stripe_controller_create_checkout_session_for_stripe(
        ...
        :param create_stripe_checkout_session_request_dto: (required)
        :type create_stripe_checkout_session_request_dto: CreateStripeCheckoutSessionRequestDto
        ...
        _param = self._stripe_controller_create_checkout_session_for_stripe_serialize(
            create_stripe_checkout_session_request_dto=create_stripe_checkout_session_request_dto,
    ...
    async def stripe_controller_create_checkout_session_for_stripe_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CheckoutSessionEntity]:
        """stripe_controller_create_checkout_session_for_stripe
    ...
    def _stripe_controller_create_checkout_session_for_stripe_serialize(
        self,
        create_stripe_checkout_session_request_dto,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_stripe_checkout_session_request_dto is not None:
            _body_params = create_stripe_checkout_session_request_dto
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/stripe/checkout-session',
    ...
    async def stripe_controller_stripe_webhook(
        ...
        :param stripe_signature: (required)
        ...
        _param = self._stripe_controller_stripe_webhook_serialize(
    ...
    def _stripe_controller_stripe_webhook_serialize(
        self,
        stripe_signature,
        _request_auth,
        _content_type,
