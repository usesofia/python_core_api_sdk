...
class IamAuthApi:
    ...
    async def auth_controller_me(
        ...
        _param = self._auth_controller_me_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def auth_controller_me_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    async def auth_controller_me_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _auth_controller_me_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
