...
class SubscriptionProductsApi:
    ...
    async def subscription_products_controller_list(
    ...
    ) -> List[SubscriptionProductEntity]:
        ...
        _param = self._subscription_products_controller_list_serialize(
    ...
    async def subscription_products_controller_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SubscriptionProductEntity]]:
        """subscription_products_controller_list
    ...
    def _subscription_products_controller_list_serialize(
        self,
        workspace_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/workspaces/{workspaceId}/subscription-products',
