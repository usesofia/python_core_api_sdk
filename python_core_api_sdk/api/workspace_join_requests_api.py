...
class WorkspaceJoinRequestsApi:
    ...
    async def workspace_join_requests_controller_create_new_pending_or_return_current(
        ...
        _param = self._workspace_join_requests_controller_create_new_pending_or_return_current_serialize(
    ...
    async def workspace_join_requests_controller_create_new_pending_or_return_current_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WorkspaceJoinRequestEntity]:
        """workspace_join_requests_controller_create_new_pending_or_return_current
    ...
    def _workspace_join_requests_controller_create_new_pending_or_return_current_serialize(
        self,
        workspace_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/workspaces/{workspaceId}/join-requests',
