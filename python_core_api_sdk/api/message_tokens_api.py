...
class MessageTokensApi:
    ...
    async def message_tokens_controller_create_or_update_message_token(
        ...
        :param create_or_update_message_token_request_dto: (required)
        :type create_or_update_message_token_request_dto: CreateOrUpdateMessageTokenRequestDto
    ...
    def _message_tokens_controller_create_or_update_message_token_serialize(
        ...
        if create_or_update_message_token_request_dto is not None:
            _body_params = create_or_update_message_token_request_dto
