...
class BankAccountsBalanceReportEntity(BaseModel):
    ...
    bank_accounts: List[BankAccountEntity] = Field(alias="bankAccounts")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [BankAccountsBalanceReportItemEntity.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "bankAccounts": [BankAccountEntity.from_dict(_item) for _item in obj["bankAccounts"]] if obj.get("bankAccounts") is not None else None
        })
        return _obj
