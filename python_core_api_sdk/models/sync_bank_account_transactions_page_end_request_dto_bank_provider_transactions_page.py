...
class SyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPage(BaseModel):
    """
    ...
    transactions: List[SyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner]
    __properties: ClassVar[List[str]] = ["pageNumber", "pageSize", "totalPages", "totalResults", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transactions": [SyncBankAccountTransactionsPageEndRequestDtoBankProviderTransactionsPageTransactionsInner.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
