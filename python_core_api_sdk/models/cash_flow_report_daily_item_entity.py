...
class CashFlowReportDailyItemEntity(BaseModel):
    """
    CashFlowReportDailyItemEntity
    """ # noqa: E501
    index: Union[StrictFloat, StrictInt]
    var_date: datetime = Field(alias="date")
    day_of_year: Union[StrictFloat, StrictInt] = Field(alias="dayOfYear")
    label: StrictStr
    min_date: datetime = Field(alias="minDate")
    max_date: datetime = Field(alias="maxDate")
    value: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["index", "date", "dayOfYear", "label", "minDate", "maxDate", "value"]
