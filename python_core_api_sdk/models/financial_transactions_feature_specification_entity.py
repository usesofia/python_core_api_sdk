...
class FinancialTransactionsFeatureSpecificationEntity(BaseModel):
    """
    FinancialTransactionsFeatureSpecificationEntity
    """ # noqa: E501
    id: StrictStr
    unlimited: StrictBool
    max_per_month: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxPerMonth")
    subscription_product_id: StrictStr = Field(alias="subscriptionProductId")
    __properties: ClassVar[List[str]] = ["id", "unlimited", "maxPerMonth", "subscriptionProductId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maxPerMonth": obj.get("maxPerMonth"),
