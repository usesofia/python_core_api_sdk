...
class UpdateBankTransactionRequestDto(BaseModel):
    """
    UpdateBankTransactionRequestDto
    """ # noqa: E501
    description: Optional[StrictStr] = None
    category_id: Optional[StrictStr] = Field(default=None, alias="categoryId")
    competency_date: Optional[datetime] = Field(default=None, alias="competencyDate")
    ...
    __properties: ClassVar[List[str]] = ["description", "categoryId", "competencyDate", "ignore", "confirm", "tagIds", "legalNature"]
