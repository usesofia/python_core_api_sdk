...
class BankAccountsBalanceReportEntityBankAccountsInner(BaseModel):
    ...
    bank_connection: BankAccountEntityBankConnection = Field(alias="bankConnection")
    provider: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bankConnection": BankAccountEntityBankConnection.from_dict(obj["bankConnection"]) if obj.get("bankConnection") is not None else None,
