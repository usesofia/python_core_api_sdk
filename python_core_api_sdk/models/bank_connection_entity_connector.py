...
class BankConnectionEntityConnector(BaseModel):
    """
    ...
    provider: StrictStr
    name: StrictStr
    institution_url: StrictStr = Field(alias="institutionUrl")
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PERSONAL_BANK', 'BUSINESS_BANK', 'INVESTMENT', 'DIGITAL_ECONOMY', 'OTHER']):
            raise ValueError("must be one of enum values ('PERSONAL_BANK', 'BUSINESS_BANK', 'INVESTMENT', 'DIGITAL_ECONOMY', 'OTHER')")
        return value
