...
class UserWithProfileEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "email", "createdAt", "passwordHash", "profile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "profile": ProfileEntity.from_dict(obj["profile"]) if obj.get("profile") is not None else None
        })
        return _obj
