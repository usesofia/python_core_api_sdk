...
class BankTransactionPaymentDataEntity(BaseModel):
    """
    BankTransactionPaymentDataEntity
    """ # noqa: E501
    id: StrictStr
    transaction_id: StrictStr = Field(alias="transactionId")
    payeer_name: Optional[StrictStr] = Field(default=None, alias="payeerName")
