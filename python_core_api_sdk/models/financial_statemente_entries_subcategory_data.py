...
class FinancialStatementeEntriesSubcategoryData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["subcategoryId", "subcategoryName", "outcome"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subcategoryName": obj.get("subcategoryName"),
