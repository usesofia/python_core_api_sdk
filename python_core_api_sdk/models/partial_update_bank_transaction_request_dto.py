...
class PartialUpdateBankTransactionRequestDto(BaseModel):
    """
    PartialUpdateBankTransactionRequestDto
    """ # noqa: E501
    description: Optional[StrictStr] = None
    category_id: Optional[StrictStr] = Field(default=None, alias="categoryId")
    competency_date: Optional[StrictStr] = Field(default=None, alias="competencyDate")
    ignore: Optional[StrictBool] = None
    verify: Optional[StrictBool] = None
    tag_ids: Optional[List[StrictStr]] = Field(default=None, alias="tagIds")
    legal_nature: Optional[StrictStr] = Field(default=None, alias="legalNature")
    __properties: ClassVar[List[str]] = ["description", "categoryId", "competencyDate", "ignore", "verify", "tagIds", "legalNature"]
