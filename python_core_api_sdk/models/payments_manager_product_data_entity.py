...
class PaymentsManagerProductDataEntity(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "prices"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "prices": [PaymentsManagerProductPriceEntity.from_dict(_item) for _item in obj["prices"]] if obj.get("prices") is not None else None
        })
        return _obj
