...
class FinancialStatementeEntriesCategoryData(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subcategories": [FinancialStatementeEntriesSubcategoryData.from_dict(_item) for _item in obj["subcategories"]] if obj.get("subcategories") is not None else None
        })
        return _obj
