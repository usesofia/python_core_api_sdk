...
class CashFlowByCategoryReportItemEntity(BaseModel):
    """
    ...
    absolute_value: Union[StrictFloat, StrictInt] = Field(alias="absoluteValue")
    percentage: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["categoryId", "categoryName", "absoluteValue", "percentage"]
