...
class CreateOrUpdateBankTransactionsInBulkRequestDtoItemsInnerLegalNatureGuessesInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["legalNature", "confidenceScore", "guesserModelId"]
