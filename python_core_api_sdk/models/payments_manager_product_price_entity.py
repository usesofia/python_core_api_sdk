...
class PaymentsManagerProductPriceEntity(BaseModel):
    """
    PaymentsManagerProductPriceEntity
    """ # noqa: E501
    id: StrictStr
    active: StrictBool
    unit_amount: Union[StrictFloat, StrictInt] = Field(alias="unitAmount")
    interval: StrictStr
    __properties: ClassVar[List[str]] = ["id", "active", "unitAmount", "interval"]
