...
async with python_core_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IamAuthApi->auth_controller_generate_phone_in_use_report:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IamAuthApi->auth_controller_generate_phone_in_use_report: %s\n" % e)
```
...
async with python_core_api_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of IamAuthApi->auth_controller_refresh:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling IamAuthApi->auth_controller_refresh: %s\n" % e)
```
